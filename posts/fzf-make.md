...
## Rustを触ってみて感じたこと
Rustを触る前に持っていた印象は「コンパイルが通りにくくて安全性が優れている」「関数型っぽい」「むずそう」という感じだった。

実際に学んでみた印象は次のような感じ。

- 関数型っぽい書き心地
  - 特にenumとパターンマッチング,option,Result型, 式指向なところなどの関数型っぽい言語機能や極力データをイミュータブルに扱う思想などが好みな感じだった。個人的にはElm(ウェブブラウザベースのGUIを作成するための純粋関数型 [Elm (プログラミング言語)](https://ja.wikipedia.org/wiki/Elm_(%E3%83%97%E3%83%AD%E3%82%B0%E3%83%A9%E3%83%9F%E3%83%B3%E3%82%B0%E8%A8%80%E8%AA%9E)))の好きな部分をほとんど含んでいるし、Elmを書いた経験も活きたので楽しくコードを書くことができた。(もちろん慣れてないこともあってElmよりも全然難しかったけど) 
