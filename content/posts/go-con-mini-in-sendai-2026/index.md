...
お話したこと
- sqlcだと引数に応じてwhere句を一部変更するとかができないのでどうやっているのか。
...
## 感想
- ソロ参加だったがセッションの合間や懇親感でたくさんの人と交流できてとても楽しかった。
...
- 運営、登壇者、発表者、スポンサーの皆様ありがとうございました！

## 振り返り
- セッションの合間は発表者の方に質問するためにウロウロしている時間が長かったのもあり、全スポンサーブースを回れなかった。もうちょっといい感じに時間を使えるとよさそう。（スポンサーブースで各社の方とお話するは楽しいので全部回りたい気持ち）
