...
過去に[The Rust Programming Language](https://doc.rust-jp.rs/book-ja/)を読んだときもスマートポインターまわりなどは飛ばしつつ読んでいたので本書での学びは多かった。
...
[^3]: あるいは各種概念を自作するという選択肢もあるかもしれない。Arcとか非同期ランタイムとか...。
[^4]: 他には[詳解 Rustアトミック操作とロック](https://www.oreilly.co.jp/books/9784814400515/)、[Async Rust
