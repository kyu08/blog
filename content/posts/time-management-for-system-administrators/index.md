...
一日の始まりにその日の予定を反映する。[^2]具体的な処理は以下。
...
以前似たような経験をしたので共感した。例えばひとりPJだとスケジュール管理もタスクの実行も自分でやる必要があるが、自分の選択に自信がないときに今の状況や取りうる選択肢とそのメリデメ、そこからなぜ何を選択したかを話すだけでかなり楽になったことがあった。
