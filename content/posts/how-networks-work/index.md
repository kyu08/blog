...
去年は[コンピュータシステムの理論と実装](https://www.oreilly.co.jp/books/9784814400874/)を読んでコンピューターについて広く浅く理解することができたので次はネットワーク周りを強化しようと思い、読んでみた。(他にもセキュリティ、データ構造とアルゴリズム、データベース、プロトコルスタック、シェルあたりが気になっている)
...
次は[Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/)でOS周りの深堀りをしていこうと思っている。メモリ管理やプロセス、スレッド周りの解像度を上げたい。あと課題でCを書く必要があるのも若干良さそうに感じたポイントでもある。(Cを書くのは辛いが、その分頑張りが身になる感覚があり...)[^1]
...
[^2]: なお、内容は無料でWebで公開されているので無課金で学習することも可能。自分は移動時間に読んだり書き込んだりしたかったので[PDF](https://remzi.gumroad.com/l/exGpf)を購入した。(それでも$10という破格)
